"""Runtime IBus engine wiring for kdictate."""
...
def create_ibus_engine_class(ibus_module: ModuleType | None = None) -> type[Any]:
    ...
    class KDictateEngine(ibus.Engine):  # type: ignore[misc,valid-type]
    ...
    return KDictateEngine



def build_engine_factory(bus: Any | None = None, ibus_module: ModuleType | None = None) -> Any:
    """Build an IBus factory that can construct the kdictate engine."""
